        ...
        mRecyclerView.addItemDecoration(object : ItemDivider(this) {
            override fun getDivider(position: Int): Divider {
                ...
                return DividerBuilder()
                    .setTopSideLine(
                        SideLine(
                            true, Color.RED, ContextCompat.getDrawable(
                                this@RecyclerDividerActivity,
                    ...
                    0 -> DividerBuilder()
                        .setLeftSideLine(
                            SideLine(
                                true, Color.RED, ContextCompat.getDrawable(
                                    this@RecyclerDividerActivity,
                                    R.drawable.item_h_divider
                                ), 10f, -10f, -6f
                            )
                        )
                        .setRightSideline(
                            SideLine(
                                true, Color.GREEN, ContextCompat.getDrawable(
                                    this@RecyclerDividerActivity,
                                    R.drawable.item_h_divider
                                ), 10f, -10f, -6f
                            )
                        ...
                        .setTopSideLine(
                            SideLine(
                                true, Color.GRAY, ContextCompat.getDrawable(
                                    this@RecyclerDividerActivity,
                                    R.drawable.item_divider
                                ), 10f, 0f, 0f
                            )
